...
* Setup =geiser=
  ...
  #+begin_src emacs-lisp
    (use-package geiser
      :custom
      (geiser-active-implementations '(mit guile chez)))
   ...
   #+begin_src emacs-lisp
     (use-package org
       ...
       (setq org-latex-minted-options
             '(("linenos=true")))
       (if (file-exists-p "~/documents/ding.wav")
           (setq org-clock-sound "~/documents/ding.wav"))
...
** Setup =org-roam=
   ...
   #+begin_src emacs-lisp
     ...
     (use-package org-roam
       ...
       (org-roam-dailies-direcdtory "daily/")
...
* Setup =mu4e=
  ...
  #+begin_src emacs-lisp
    (use-package mu4e
      ...
      ;;; Bookmarks
      (setq mu4e-bookmarks
            '((:name "Linux ARM MSM" :query "list:linux-arm-msm.vger.kernel.org AND flag:unread AND NOT flag:trashed" :key ?m)
              (:name "Linux-USB" :query "list:linux-usb.vger.kernel.org AND flag:unread AND NOT flag:trashed" :key ?u)
