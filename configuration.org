...
#+BEGIN_SRC emacs-lisp
  (setenv "PATH"
	  (concat "/home/balbi/.gem/ruby/2.6.0/bin:/home/balbi/.local/bin:/usr/lib/ccache:"
		  (getenv "PATH")))
#+END_SRC
...
* Setup =emacs-color-theme-solarized=

I've gotten used to the look and feel of =emacs-color-theme-solarized=
(specially with a dark background) and plan to continue using it. In
order to use it, I need to first clone the github repository:

#+BEGIN_SRC sh :eval no
  $ git clone https://github.com/sellout/emacs-color-theme-solarized.git
#+END_SRC

After that, I just need to load the theme

#+BEGIN_SRC emacs-lisp
  (add-to-list 'custom-theme-load-path "~/workspace/dotconfig/emacs-color-theme-solarized")
...
#+BEGIN_SRC emacs-lisp
  (defvar my/basic-org-capture-template
    "* TODO %^{Task}
  :PROPERTIES:
  :Captured: %T
  :END:
  ...
  (defvar my/filename nil)

  (defun my/org-capture ()
    "Asks user for a filename and runs org-capture for that file"
    (interactive)
    (setq my/filename (helm-read-file-name
		       "Choose File: "
		       :initial-input (concat org-directory "/projects/")))
    (org-capture))

  (setq org-capture-templates
	`(("t" "Todo" entry (file my/filename)
	   ,my/basic-org-capture-template)))
#+END_SRC
